...
def get_conversational_chain():
    ...
    Context:\n {context}?\n
    Question: \n{question}\n .Provide the summary of complete answer at the begining and then provide the rest of the answer transformed into easy to understand langauge. Limit the detailed answer and reword each point into more easy language.
