...
def get_conversational_chain():
    ...
    Context:\n {context}?\n
    Question: \n{question}\n .Provide the short summary paragraph with easy to comprehend language of complete answer at the begining and then provide the detailed answer. Detailed answer should be crisp and reword each point into more easy language.
